...
python3 -m unittest discover -s tests -v > reports/tests.log 2>&1
python3 scripts/record_tests.py native
GSR_EVAL_BINARY="$PWD/build/profile/bin/bitcoin-util" python3 -m unittest discover -s tests -v > reports/tests-profiled.log 2>&1
